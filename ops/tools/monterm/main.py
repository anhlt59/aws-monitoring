...
from ops.tools.monterm.adapters.terminal_ui import TerminalUI
from ops.tools.monterm.constants import AGENT_CONFIG_DIR, DEFAULT_CONFIG_DIR
from ops.tools.monterm.services.profile_service import ProfileService
    ...
    def run(self) -> None:
        ...
        while True:
            try:
                ...
                # Show profiles list
                self.ui.show_profiles_list(profiles, self.config_dir)

                # Select profile
                selected = self.ui.select_profile(profiles, include_create=True)
