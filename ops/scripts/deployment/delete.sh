...
echo -e "${GREEN}${BOLD}Deleting 'teligent' in stage '${STAGE}'...${RESET}"
echo -e "${BLUE}pnpm exec sls remove --stage ${STAGE} --config ${TEMPLATE_PATH}${RESET}"
pnpm exec sls remove --stage "$STAGE" --config "$TEMPLATE_PATH"
