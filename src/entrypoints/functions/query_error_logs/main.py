...
from src.domain.use_cases.monitor_log_groups import QueryParam, monitor_log_groups_use_case
from src.infra import CloudwatchLogService, ECSService, EventBridgeService, LambdaService
...
def handler(event, context):
    try:
        ...
        monitor_log_groups_use_case(query, log_service, publisher)
